...
#         cfg = OmegaConf.create(ckpt['hyper_parameters'])
        ...
        self.tokenizer = get_tokenizer() # надо будет скачать #instantiate(cfg._data.tokenizer)
        self.image_transform = args.img_transform #get_image_transform(randomize=False)
